...
func init() {
	...
	// bsc chainConfig
	RegisterChainSpec(networkname.BSC, BSC)
	RegisterChainSpec(networkname.Chapel, Chapel)
	RegisterChainSpec(networkname.Rialto, Rialto)
...
var (
	...
	BSC = Spec{
		...
		Config:      ReadChainConfig(chainspecs, "chainspecs/bsc.json"),
